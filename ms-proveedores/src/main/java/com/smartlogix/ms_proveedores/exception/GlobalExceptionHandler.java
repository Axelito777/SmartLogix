...
/**
 * Manejador global de excepciones del microservicio de proveedores.
 *
...
public class GlobalExceptionHandler {
    ...
    /**
     * Captura {@link ProveedorNotFoundException} y la convierte en una
     * respuesta HTTP 404 con el mensaje de error.
     *
     * @param ex excepción lanzada cuando no se encuentra el proveedor solicitado
     * @return respuesta con estado 404 y el mensaje de error
     */
    @ExceptionHandler(ProveedorNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleNotFound(ProveedorNotFoundException ex) {
