...
/**
 * Manejador global de excepciones del microservicio de envíos.
 *
...
public class GlobalExceptionHandler {
    ...
    /**
     * Captura {@link EnvioNotFoundException} y la convierte en una
     * respuesta HTTP 404 con el mensaje de error.
     *
     * @param ex excepción lanzada cuando no se encuentra el envío solicitado
     * @return respuesta con estado 404 y el mensaje de error
     */
    @ExceptionHandler(EnvioNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleNotFound(EnvioNotFoundException ex) {
